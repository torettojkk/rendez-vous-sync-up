/*
  # Establishments Schema Setup

  1. New Tables
    - establishments (main table for business entities)
    - establishment_clients (junction table for client relationships)
    - invites (for managing client invitations)
  
  2. Functions
    - update_appointments_count() for tracking appointment statistics
  
  3. Security
    - RLS enabled on all tables
    - Policies for CEO, owners, and clients
*/
...
-- Create function for updating appointments count
