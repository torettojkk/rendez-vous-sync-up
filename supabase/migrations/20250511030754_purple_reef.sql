/*
  # Schema update for multi-establishment system

  1. New Tables
    - `establishments`
      - Basic establishment info (name, description, etc)
      - Unique slug for invite links
      - Premium status and appointment tracking
    - `establishment_clients`
      - Links clients to establishments
      - Tracks relationship status
    - `invites`
      - Manages email/phone invites
  ...
  3. Functions
    - Appointment counter update trigger
*/
